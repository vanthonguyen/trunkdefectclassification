#include "Descripteur3D.h"

using namespace DGtal;

std::array<double, 3> Descripteur3D::compute(double &u200, double &u020, double &u002){
    double j1, j2, j3;
...
std::array<double, 3> Descripteur3D::compute(){
    double u200, u020, u002;
    return compute(u200, u020, u002);
}

Z3i::RealPoint Descripteur3D::computeCentroid(){
...
double Descripteur3D::boundingboxVolume(){
    return
}
