...
//std::cout<<"ransac:"<<std::endl;
    ...
    static std::pair<double, double> linearRegression(const std::vector<double> &xs, const std::vector<double> &ys, const double &resolution){
    ...
    static std::pair<double, double> linearRegression(const std::vector<double> &xs, const std::vector<double> &ys, const double &resolution, const double &eps){
    ...
    static std::pair<double, double> ransac(const std::vector<double> xs, std::vector<double> ys, double epsilon, int minNbIter, double probability=0.9999){
        ...
        while (nbSamples < numberOfIteration){
            ...
            numberOfIteration = log10(1 - probability)/log10(1 - pow(w, 2));
    ...
    static std::pair<double, double> ransac(const std::vector<double> xs, std::vector<double> ys, double epsilon, int minNbIter, double probability, double resolution){
        //use pcl instead of mine?
        std::pair<double, double> coefficients;
        srand (time(NULL));
        //std::pair<double, double> coeffsRmse = rmse(xs, ys);
